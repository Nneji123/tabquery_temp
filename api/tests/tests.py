...
def test_execute_query_csv():
    assert str(execute_query_csv(question_csv, "salaries.csv")) == "{'query': 'what is the average salary?', 'result': ['80000', 'AVERAGE']}"
    
def test_execute_query_excel():
    assert str(execute_query_excel(question_excel, "diabetes.xlsx")) == "{
